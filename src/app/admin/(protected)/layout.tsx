    ...
    <div className="min-h-[calc(100vh-64px)] bg-zinc-50 dark:bg-zinc-950">
      <div className="container mx-auto px-4 py-6 flex flex-col lg:flex-row gap-6">
        ...
        <aside className="lg:w-64 shrink-0">
          <div className="sticky top-20 bg-white dark:bg-zinc-900 rounded-2xl border-2 border-[#0038A0]/10 shadow-sm overflow-hidden">
            <div className="bg-[#002070] text-white p-4">
              <p className="font-black text-sm tracking-tight flex items-center gap-2"><span className="h-2 w-2 rounded-full bg-[#0038A0] animate-pulse" /> Admin</p>
              <p className="text-xs text-zinc-400">Syntech Limited • Secure</p>
            </div>
            <nav className="p-2 space-y-1">
              {nav.map((n) => (
                <Link
                  key={n.href}
                  href={n.href as any}
                  className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium hover:bg-[#F5F7FA] hover:text-[#002070] transition"
                >
