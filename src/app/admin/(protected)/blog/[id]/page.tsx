      ...
      <Card className="border-2 border-[#0038A0]/20">
        ...
        <CardContent>
          <form action={`/api/posts?id=${post.id}`} method="post" className="space-y-3">
            ...
            <input name="title" defaultValue={post.title} required className="w-full border-2 border-zinc-200 focus:border-[#0038A0] rounded-lg px-3 py-2.5 text-sm outline-none" />
            ...
            <textarea name="content" defaultValue={post.content} rows={8} required className="w-full border-2 border-zinc-200 focus:border-[#0038A0] rounded-lg px-3 py-2.5 text-sm outline-none" />
            ...
            <div className="flex gap-4">
              <label className="flex items-center gap-2 text-sm"><input type="checkbox" name="published" defaultChecked={post.published} className="accent-[#0038A0]" /> Published</label>
              <label className="flex items-center gap-2 text-sm"><input type="checkbox" name="featured" defaultChecked={post.featured} className="accent-[#0038A0]" /> Featured</label>
            </div>
