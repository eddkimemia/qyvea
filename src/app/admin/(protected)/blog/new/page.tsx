      ...
      <Card className="border-2 border-[#0038A0]/20">
        ...
        <CardContent>
          <form action="/api/posts" method="post" className="space-y-3">
            <input name="title" placeholder="Title * e.g. CCTV Cost Kenya 2026" required className="w-full border-2 border-zinc-200 focus:border-[#0038A0] rounded-lg px-3 py-2.5 text-sm outline-none" />
            ...
            <input name="excerpt" placeholder="Excerpt (150 chars) — shows in cards & SEO" required className="w-full border-2 border-zinc-200 focus:border-[#0038A0] rounded-lg px-3 py-2.5 text-sm outline-none" />
            <textarea name="content" placeholder="Content * (supports line breaks)" rows={8} required className="w-full border-2 border-zinc-200 focus:border-[#0038A0] rounded-lg px-3 py-2.5 text-sm outline-none" />
            ...
            <div className="flex gap-4">
              <label className="flex items-center gap-2 text-sm"><input type="checkbox" name="published" defaultChecked className="accent-[#0038A0]" /> Published</label>
