...
export default function PartnersPage(){
  return <div className="container mx-auto px-4 py-10">
    ...
    <div className="grid md:grid-cols-3 gap-6 mt-6">
      <Card><CardHeader><CardTitle>Your Link</CardTitle></CardHeader><CardContent className="text-sm"><code className="bg-zinc-100 px-2 py-1 rounded">qyvea.co.ke?ref=QYV-XXXX</code><p className="text-zinc-500 mt-2">Share via WhatsApp / social. Demo: QYV-PARTNER-001</p></CardContent></Card>
