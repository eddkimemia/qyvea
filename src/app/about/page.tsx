  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-10">
      ...
      <div className="relative rounded-2xl overflow-hidden">
        <img src={IMAGES.about.office} alt="Qyvea office Nairobi" className="absolute inset-0 h-full w-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-[#0A0A0A]/80 to-black/30" />
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-[#7FAF25]" />
        <div className="relative p-6 md:p-10 max-w-3xl">
          <Badge className="bg-[#7FAF25] text-black font-bold mb-3">About Qyvea Limited</Badge>
          <h1 className="text-3xl md:text-4xl font-black text-white tracking-tight leading-tight">Built to Protect —<br /><span className="text-[#7FAF25]">Built to Last.</span></h1>
          ...
          <div className="mt-5 flex gap-3">
            ...
            <Link href="#team"><Button size="sm" className="bg-[#7FAF25] text-black hover:bg-[#6A9A1F]">Meet the Team</Button></Link>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-5 md:gap-6 mt-8">
        ...
        <Card className="border-2 border-[#0A0A0A]/10 hover:shadow-md transition">
        ...
        <Card className="border-2 border-[#7FAF25]/10 hover:shadow-md transition bg-[#F2F9E6]">
      ...
      <div id="story" className="grid md:grid-cols-2 gap-6 md:gap-8 mt-8">
        <Card className="overflow-hidden">
          ...
          <CardContent className="pt-4">
            <ol className="relative border-l-2 border-[#7FAF25]/30 pl-6 space-y-6 text-sm">
              {[
                ...
                <li key={year} className="relative"><span className="absolute -left-[29px] top-0 h-4 w-4 rounded-full bg-[#7FAF25] border-2 border-white shadow" /><span className="font-bold text-[#3F5D13]">{year}</span> — {text}</li>
              ))}
            </ol>
          </CardContent>
        </Card>
        <Card className="border-2 border-[#7FAF25]/20">
          ...
          <CardContent className="text-sm space-y-2.5">
            <p className="flex justify-between border-b py-1.5"><span className="text-zinc-500">Company</span><span className="font-semibold">Qyvea Limited Kenya Ltd</span></p>
            ...
            <p className="flex justify-between"><span className="text-zinc-500">Insurance</span><span className="font-bold text-[#5A7F1B]">KES 50M All-Risk</span></p>
      ...
      <div className="grid md:grid-cols-4 gap-5 mt-6">
        {[
          ...
          <Card key={name} className="hover:border-[#7FAF25]/30 hover:shadow-md transition overflow-hidden group">
            <div className="h-20 bg-gradient-to-br from-[#7FAF25] to-[#557A19] relative">
              <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 h-16 w-16 rounded-2xl bg-white shadow-lg grid place-items-center font-black text-[#3F5D13] border-2 border-[#7FAF25] group-hover:scale-105 transition">{initials}</div>
            </div>
            <CardContent className="pt-10 text-center"><p className="font-bold">{name}</p><p className="text-xs text-[#5A7F1B] font-semibold uppercase tracking-widest">{role}</p><p className="text-xs text-zinc-600 mt-2 leading-relaxed">{bio}</p></CardContent>
          </Card>
        ))}
      </div>

      <div className="grid grid-cols-3 gap-4 md:gap-6 mt-10 text-center">
        <Card className="bg-[#0A0A0A] text-white border-0"><CardContent className="pt-6"><div className="text-3xl font-black text-[#7FAF25]">500+</div><div className="text-sm text-zinc-400">Projects Completed</div></CardContent></Card>
        <Card className="bg-[#7FAF25] text-black border-0"><CardContent className="pt-6"><div className="text-3xl font-black">47</div><div className="text-sm font-medium">Counties Served</div></CardContent></Card>
        <Card className="border-2 border-[#7FAF25]"><CardContent className="pt-6"><div className="text-3xl font-black text-[#3F5D13]">98%</div><div className="text-sm text-zinc-600 font-medium">Client Satisfaction</div></CardContent></Card>
      </div>
